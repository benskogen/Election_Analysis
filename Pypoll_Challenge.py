...
file_to_load = "01-Assignments/03-PyPoll/Resources/election_results.csv"
...
# 1: Create a county list and county votes dictionary. # creating empty lists / dictionaries.
county_options = []
county_votes = {}
